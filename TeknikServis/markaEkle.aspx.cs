...
namespace TeknikServis
{
    public partial class markaEkle : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            //string sorgu = "insert into markaTablosu (markaAdi) values ('"+TextBox1.Text+"')";
            ...
            Proje.Siniflar.markaTablosu baglanti = new Proje.Siniflar.markaTablosu();
            Proje.DataAccess.markaTablosu veriAlma = new Proje.DataAccess.markaTablosu();

            try
            {
                veriAlma.markaAdi = TextBox1.Text;
